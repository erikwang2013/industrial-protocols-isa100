# ISA100.11a 协议包 — 工业无线 mesh，需 ISA100 网关桥接

> [中文](README.md)

ISA100.11a 协议包 — 工业无线 mesh，需 ISA100 网关桥接。Requires dedicated hardware, bridged to vendor SDK or gateway via kernel Bridge layer.
...
Yokogawa (YFGW410 Field Wireless Gateway), Honeywell (OneWireless), GE (Bently Nevada)
...
- ISA100.11a wireless gateway (Yokogawa YFGW410, Honeywell OneWireless)
